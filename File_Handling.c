...
int main()
{
    ...
    SD_Init();
    SD_Transfer_write(FILE,(u32)src_str,(len+1000));// When the len is directly specified, it is not written, you need to specify a larger length to write out, the reason is unknown
